...
// NewIQCBlockScanner create a block scanner
func NewIQCBlockScanner(wm *WalletManager) *IQCBlockScanner {
	bs := IQCBlockScanner{
...
func (bs *IQCBlockScanner) getCurrentBlock() (*client.Block, error) {
...
func (bs *IQCBlockScanner) GetGlobalMaxBlockHeight() uint64 {
...
func (bs *IQCBlockScanner) getBlockByHeight(height uint64) (*client.Block, error) {
...
func (bs *IQCBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *IQCBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *IQCBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *IQCBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.GetLocalBlockHead()
	return localHeight
}

//GetTransactionsByBlockHash
func (bs *IQCBlockScanner) getTransactionsByBlock(hash string) (*client.Transactions, error) {
...
//GetBlockHeight 获取区块链高度
func (bs *IQCBlockScanner) GetBlockHeight() (uint64, error) {
	//暂时只有一个接口获取钱包高度
	return bs.GetGlobalMaxBlockHeight(), nil
}

//newBlockNotify 获得新区块后，通知给观测者
func (bs *IQCBlockScanner) newBlockNotify(block *client.Block, isFork bool) {
...
func (bs *IQCBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *IQCBlockScanner) ExtractTransaction(block *client.Block, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractResult, error) {
...
//ExtractTransaction 提取交易单
func (bs *IQCBlockScanner) ExtractTransactionSingleTx(block *client.Block, tx *client.Transaction, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractTxResult, error) {
	return bs.changeTrans(tx, scanTargetFunc)

}

func (bs *IQCBlockScanner) changeTrans(trans *client.Transaction, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractTxResult, error) {
	v := trans
...
func (bs *IQCBlockScanner) newExtractDataNotify(height uint64, extractTxResult []*ExtractTxResult) error {
...
func (bs *IQCBlockScanner) BatchExtractTransaction(block *client.Block) error {
...
func (bs *IQCBlockScanner) RescanFailedRecord() {
...
//IQCBlockScanner 扫描任务
func (bs *IQCBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *IQCBlockScanner) ScanBlock(height uint64) error {
...
//ScanBlock 扫描指定高度区块
func (bs *IQCBlockScanner) scanBlock(height uint64) (*client.Block, error) {
...
func (bs *IQCBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
func (bs *IQCBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
//@optional
func (bs *IQCBlockScanner) SupportBlockchainDAI() bool {
	return true
}
